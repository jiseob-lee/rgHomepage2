...
<html lang="ko">
  ...
  <body>
    ...
    <script>
      ...
      const widgetClientKey = "test_gck_EP59LybZ8BLeONlpAnRQV6GYo7pR";
      ...
      button.addEventListener("click", function () {
        ...
        paymentWidget.requestPayment({
          ...
          successUrl: window.location.origin + "/toss/success.do",
          failUrl: window.location.origin + "/toss/fail.do",
