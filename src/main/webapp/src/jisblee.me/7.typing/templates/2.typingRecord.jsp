...
<form name="frm">
  ...
  <div style="margin: 10px; float: left; font-size: 11pt;">
  ...
  <table class="notice">
    ...
    <tr ng-repeat="dummy in list2">
      ...
      <td align="center">{{list2[$index].timeElapsedString }}</td>
  ...
  linkEnd : {{linkEnd}}<br/>
  -->
  <span ng-if="linkStart > pageLinkCount">&nbsp;<a href="#/typingRecord/{{linkStart - pageLinkCount}}">&lt;</a></span>
  <span ng-repeat="n in [] | range:this">
    <span ng-if="n == pageNo">&nbsp;<b>{{n}}</b>&nbsp;</span>
    <span ng-if="n != pageNo">&nbsp;<a href="#/typingRecord/{{n}}">{{n}}</a>&nbsp;
    </span>
  </span>
  <span ng-if="linkStart + pageLinkCount <= linkEnd">&nbsp;<a href="#/typingRecord/{{linkStart + pageLinkCount}}">&gt;</a></span>
  &nbsp;
