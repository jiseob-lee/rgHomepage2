var appStatistics = angular.module('rg.BoardView', ['angularMoment', 'ngMaterial', 'ngMessages']);

appStatistics.controller('BoardViewCtrl', ['$scope', '$http', '$routeParams', '$log', '$location', 
